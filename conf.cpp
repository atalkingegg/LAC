...
void save_config ()
    ...
    cf->writeText ((char *)"# in use.");
    cf->writeText ((char *)"# ");
    cf->writeText ((char *)"# Set NetworkMode as follows:");
    cf->writeText ((char *)"# ");
    cf->writeText ((char *)"# For PeerToPeer mode, set NetworkMode to 0.");
    cf->writeText ((char *)"# For ClientServer mode, set NetworkMode to 1. This is the default.");
    cf->writeText ((char *)"");
